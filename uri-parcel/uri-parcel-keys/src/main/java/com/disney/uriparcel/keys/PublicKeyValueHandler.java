...
/**
 * Handler for storing and retrieving public keys from PKCS8 PEM files
 *
 * @author Alex Vigdor
 */
public class PublicKeyValueHandler extends AbstractValueHandler {
	...
	public boolean isSupported(@SuppressWarnings("rawtypes") Class valueClass, String contentType) {
		return PublicKey.class.isAssignableFrom(valueClass);
	}
