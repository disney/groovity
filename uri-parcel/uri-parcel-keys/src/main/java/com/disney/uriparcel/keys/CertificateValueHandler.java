...
/**
 * ValueHandler for converting between X.509 certificates and java Certificate objects
 *
 * @author Alex Vigdor
 */
public class CertificateValueHandler extends AbstractValueHandler {
	...
	public boolean isSupported(@SuppressWarnings("rawtypes") Class valueClass, String contentType) {
		return Certificate.class.isAssignableFrom(valueClass);
	}
