 ...
 */
public interface AsyncChannelAnonymousManagerMBean {
    /**
     * returns the number of currently open anonymous channels
     */
    public int getNumberOfCurrentlyOpenChannels();

    /**
     * returns the aggregate total anonymous channels opened
     */
