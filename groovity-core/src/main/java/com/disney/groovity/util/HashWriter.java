...
/**
 * HashWriter converts characters to bytes, hashes them and discards them as they are written
 * 
 * @author Alex Vigdor
 *
 */
public class HashWriter extends Writer {
	...
	public HashWriter(MessageDigest digest, CharsetEncoder encoder ) {
		this.digest = digest;
