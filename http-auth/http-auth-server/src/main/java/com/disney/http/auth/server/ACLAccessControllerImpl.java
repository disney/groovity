 ...
 * @author Alex Vigdor
 */
public class ACLAccessControllerImpl implements AccessController {
	private List<String> acl;

	public ACLAccessControllerImpl(){
		
	}
	
	public ACLAccessControllerImpl(List<String> acl){
		this.acl=acl;
	}
	
	@Override
	public boolean allow(Principal principal, AuthorizationRequest request) {
		return acl.contains(principal.getName());
	}
