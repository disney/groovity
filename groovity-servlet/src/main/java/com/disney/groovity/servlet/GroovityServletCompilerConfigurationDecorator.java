...
/**
 * A compiler configuration customizer to automatically import StatusException
 *
 * @author Alex Vigdor
 */
public class GroovityServletCompilerConfigurationDecorator implements CompilerConfigurationDecorator {

	@Override
	public void decorate(CompilerConfiguration config) {
		config.addCompilationCustomizers(new ImportCustomizer().addImports(
				StatusException.class.getName()
			));
	}
